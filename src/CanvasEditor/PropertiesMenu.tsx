...
// import { Elements, isEdge, Edge, Node, removeElements, isNode } from "inputs-and-outputs-renderer";
...
//                                 </Col>
//                             </Row>
//                             <Row><button className = 'change-button' onClick={changeMode}>Change Mode</button></Row>
